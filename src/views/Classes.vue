  ...
  <div>
    <header class="bg-white shadow-sm">
      <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
        <h1 class="text-lg leading-6 font-medium text-primary-dark">
          All Classes
        </h1>
      </div>
    </header>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-md">
          <ul>
            <li class="border-t border-border-light first:border-t-0" v-for="cls in university.classes" :key="cls.id">
              ...
              <router-link :to="{name: 'class:detail', params: {id: cls.id}}" class="block hover:bg-white-light focus:outline-none focus:bg-gray-50 transition duration-300 ease-in-out">
